...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<button class='btn btn-warning btn-sm edit-enrollment' data-id='" . $row['enrollment_id'] . "'>Edit</button> ";
        echo "<button class='btn btn-danger btn-sm delete-enrollment' data-id='" . $row['enrollment_id'] . "'>Delete</button>";
        echo "</td>";
        echo "</tr>";
    }
} else {
